...
<!DOCTYPE html>
    ...
    <body>
        ...
        <%         
          ...
          String [] options1 = questions[0].getOptions();
          String [] options2 = questions[1].getOptions();
          String [] options3 = questions[2].getOptions();
             
        %>
    <form action="/L3/Controller" method="post">
 
    <p><%=questions[0].getQuestion()%></p>
    ...
    <input type="hidden" name="Quiz" value="Astronomy">
